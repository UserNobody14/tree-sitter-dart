...
/// Create a new parser.
@ffi.Native<ffi.Pointer<TSParser> Function()>(symbol: 'ts_parser_new')
...
@ffi.Native<
    ffi.Bool Function(ffi.Pointer<TSParser>, ffi.Pointer<TSRange>,
        ffi.Uint32)>(symbol: 'ts_parser_set_included_ranges')
...
@ffi.Native<
    ffi.Pointer<TSRange> Function(ffi.Pointer<TSParser>,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_parser_included_ranges')
...
@ffi.Native<
    ffi.Pointer<TSTree> Function(ffi.Pointer<TSParser>, ffi.Pointer<TSTree>,
        TSInput)>(symbol: 'ts_parser_parse')
...
@ffi.Native<
    ffi.Pointer<TSTree> Function(ffi.Pointer<TSParser>, ffi.Pointer<TSTree>,
        TSInput, TSParseOptions)>(symbol: 'ts_parser_parse_with_options')
...
@ffi.Native<
    ffi.Pointer<TSTree> Function(ffi.Pointer<TSParser>, ffi.Pointer<TSTree>,
        ffi.Pointer<ffi.Char>, ffi.Uint32)>(symbol: 'ts_parser_parse_string')
...
@ffi.Native<
    ffi.Pointer<TSTree> Function(
        ...
        ffi.Uint32,
        ffi.Int32)>(symbol: 'ts_parser_parse_string_encoding')
external ffi.Pointer<TSTree> ts_parser_parse_string_encoding(
  ffi.Pointer<TSParser> self,
  ffi.Pointer<TSTree> old_tree,
  ffi.Pointer<ffi.Char> string,
  int length,
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSParser>)>(symbol: 'ts_parser_reset')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSParser>, ffi.Uint64)>(
    symbol: 'ts_parser_set_timeout_micros')
...
@ffi.Native<ffi.Uint64 Function(ffi.Pointer<TSParser>)>(
    symbol: 'ts_parser_timeout_micros')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSParser>, ffi.Pointer<ffi.Size>)>(
    symbol: 'ts_parser_set_cancellation_flag')
...
@ffi.Native<ffi.Pointer<ffi.Size> Function(ffi.Pointer<TSParser>)>(
    symbol: 'ts_parser_cancellation_flag')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSParser>, ffi.Int)>(
    symbol: 'ts_parser_print_dot_graphs')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSTree>)>(symbol: 'ts_tree_delete')
external void ts_tree_delete(
  ffi.Pointer<TSTree> self,
);

/// Get the root node of the syntax tree.
@ffi.Native<TSNode Function(ffi.Pointer<TSTree>)>(symbol: 'ts_tree_root_node')
...
@ffi.Native<TSNode Function(ffi.Pointer<TSTree>, ffi.Uint32, TSPoint)>(
    symbol: 'ts_tree_root_node_with_offset')
...
@ffi.Native<
    ffi.Pointer<TSRange> Function(ffi.Pointer<TSTree>,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_tree_included_ranges')
...
@ffi.Native<
    ffi.Pointer<TSRange> Function(ffi.Pointer<TSTree>, ffi.Pointer<TSTree>,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_tree_get_changed_ranges')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSTree>, ffi.Int)>(
    symbol: 'ts_tree_print_dot_graph')
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(TSNode)>(symbol: 'ts_node_type')
external ffi.Pointer<ffi.Char> ts_node_type(
  TSNode self,
);

/// Get the node's type as a numerical id.
@ffi.Native<TSSymbol Function(TSNode)>(symbol: 'ts_node_symbol')
...
/// [`ts_node_symbol`].
@ffi.Native<TSSymbol Function(TSNode)>(symbol: 'ts_node_grammar_symbol')
external int ts_node_grammar_symbol(
  TSNode self,
);

/// Get the node's start byte.
@ffi.Native<ffi.Uint32 Function(TSNode)>(symbol: 'ts_node_start_byte')
external int ts_node_start_byte(
  TSNode self,
);

/// Get the node's start position in terms of rows and columns.
@ffi.Native<TSPoint Function(TSNode)>(symbol: 'ts_node_start_point')
external TSPoint ts_node_start_point(
  TSNode self,
);

/// Get the node's end byte.
@ffi.Native<ffi.Uint32 Function(TSNode)>(symbol: 'ts_node_end_byte')
external int ts_node_end_byte(
  TSNode self,
);

/// Get the node's end position in terms of rows and columns.
@ffi.Native<TSPoint Function(TSNode)>(symbol: 'ts_node_end_point')
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(TSNode)>(symbol: 'ts_node_string')
...
/// was found.
@ffi.Native<ffi.Bool Function(TSNode)>(symbol: 'ts_node_is_null')
...
/// grammar.
@ffi.Native<ffi.Bool Function(TSNode)>(symbol: 'ts_node_is_named')
...
@ffi.Native<ffi.Bool Function(TSNode)>(symbol: 'ts_node_is_missing')
...
@ffi.Native<ffi.Bool Function(TSNode)>(symbol: 'ts_node_is_extra')
external bool ts_node_is_extra(
  TSNode self,
);

/// Check if a syntax node has been edited.
@ffi.Native<ffi.Bool Function(TSNode)>(symbol: 'ts_node_has_changes')
external bool ts_node_has_changes(
  TSNode self,
);

/// Check if the node is a syntax error or contains any syntax errors.
@ffi.Native<ffi.Bool Function(TSNode)>(symbol: 'ts_node_has_error')
external bool ts_node_has_error(
  TSNode self,
);

/// Check if the node is a syntax error.
@ffi.Native<ffi.Bool Function(TSNode)>(symbol: 'ts_node_is_error')
external bool ts_node_is_error(
  TSNode self,
);

/// Get this node's parse state.
@ffi.Native<TSStateId Function(TSNode)>(symbol: 'ts_node_parse_state')
external int ts_node_parse_state(
  TSNode self,
);

/// Get the parse state after this node.
@ffi.Native<TSStateId Function(TSNode)>(symbol: 'ts_node_next_parse_state')
...
@ffi.Native<TSNode Function(TSNode)>(symbol: 'ts_node_parent')
...
@ffi.Native<TSNode Function(TSNode, TSNode)>(
    symbol: 'ts_node_child_with_descendant')
...
/// child.
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>(symbol: 'ts_node_child')
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(TSNode, ffi.Uint32)>(
    symbol: 'ts_node_field_name_for_child')
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(TSNode, ffi.Uint32)>(
    symbol: 'ts_node_field_name_for_named_child')
...
@ffi.Native<ffi.Uint32 Function(TSNode)>(symbol: 'ts_node_child_count')
...
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>(symbol: 'ts_node_named_child')
...
///
/// See also [`ts_node_is_named`].
@ffi.Native<ffi.Uint32 Function(TSNode)>(symbol: 'ts_node_named_child_count')
...
@ffi.Native<TSNode Function(TSNode, ffi.Pointer<ffi.Char>, ffi.Uint32)>(
    symbol: 'ts_node_child_by_field_name')
...
@ffi.Native<TSNode Function(TSNode, TSFieldId)>(
    symbol: 'ts_node_child_by_field_id')
...
@ffi.Native<TSNode Function(TSNode)>(symbol: 'ts_node_next_sibling')
external TSNode ts_node_next_sibling(
  TSNode self,
);

@ffi.Native<TSNode Function(TSNode)>(symbol: 'ts_node_prev_sibling')
external TSNode ts_node_prev_sibling(
  TSNode self,
);

/// Get the node's next / previous *named* sibling.
@ffi.Native<TSNode Function(TSNode)>(symbol: 'ts_node_next_named_sibling')
external TSNode ts_node_next_named_sibling(
  TSNode self,
);

@ffi.Native<TSNode Function(TSNode)>(symbol: 'ts_node_prev_named_sibling')
...
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>(
    symbol: 'ts_node_first_child_for_byte')
...
@ffi.Native<TSNode Function(TSNode, ffi.Uint32)>(
    symbol: 'ts_node_first_named_child_for_byte')
...
@ffi.Native<ffi.Uint32 Function(TSNode)>(symbol: 'ts_node_descendant_count')
...
@ffi.Native<TSNode Function(TSNode, ffi.Uint32, ffi.Uint32)>(
    symbol: 'ts_node_descendant_for_byte_range')
...
@ffi.Native<TSNode Function(TSNode, TSPoint, TSPoint)>(
    symbol: 'ts_node_descendant_for_point_range')
...
@ffi.Native<TSNode Function(TSNode, ffi.Uint32, ffi.Uint32)>(
    symbol: 'ts_node_named_descendant_for_byte_range')
...
@ffi.Native<TSNode Function(TSNode, TSPoint, TSPoint)>(
    symbol: 'ts_node_named_descendant_for_point_range')
...
@ffi.Native<ffi.Bool Function(TSNode, TSNode)>(symbol: 'ts_node_eq')
...
@ffi.Native<TSTreeCursor Function(TSNode)>(symbol: 'ts_tree_cursor_new')
...
@ffi.Native<
    ffi.Void Function(ffi.Pointer<TSTreeCursor>,
        ffi.Pointer<TSTreeCursor>)>(symbol: 'ts_tree_cursor_reset_to')
...
@ffi.Native<TSNode Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_current_node')
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_current_field_name')
...
@ffi.Native<TSFieldId Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_current_field_id')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_goto_parent')
...
/// of the cursor, and the cursor cannot walk outside this node.
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_goto_next_sibling')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_goto_previous_sibling')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_goto_first_child')
...
/// position.
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_goto_last_child')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSTreeCursor>, ffi.Uint32)>(
    symbol: 'ts_tree_cursor_goto_descendant')
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_current_descendant_index')
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSTreeCursor>)>(
    symbol: 'ts_tree_cursor_current_depth')
...
@ffi.Native<ffi.Int64 Function(ffi.Pointer<TSTreeCursor>, ffi.Uint32)>(
    symbol: 'ts_tree_cursor_goto_first_child_for_byte')
...
@ffi.Native<ffi.Int64 Function(ffi.Pointer<TSTreeCursor>, TSPoint)>(
    symbol: 'ts_tree_cursor_goto_first_child_for_point')
...
@ffi.Native<
    ffi.Pointer<TSQuery> Function(
        ...
        ffi.Pointer<ffi.Int32>)>(symbol: 'ts_query_new')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSQuery>)>(symbol: 'ts_query_delete')
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>)>(
    symbol: 'ts_query_pattern_count')
external int ts_query_pattern_count(
  ffi.Pointer<TSQuery> self,
);

@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>)>(
    symbol: 'ts_query_capture_count')
external int ts_query_capture_count(
  ffi.Pointer<TSQuery> self,
);

@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>)>(
    symbol: 'ts_query_string_count')
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>, ffi.Uint32)>(
    symbol: 'ts_query_start_byte_for_pattern')
...
/// code strings.
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSQuery>, ffi.Uint32)>(
    symbol: 'ts_query_end_byte_for_pattern')
...
@ffi.Native<
    ffi.Pointer<TSQueryPredicateStep> Function(ffi.Pointer<TSQuery>, ffi.Uint32,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_query_predicates_for_pattern')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSQuery>, ffi.Uint32)>(
    symbol: 'ts_query_is_pattern_rooted')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSQuery>, ffi.Uint32)>(
    symbol: 'ts_query_is_pattern_non_local')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSQuery>, ffi.Uint32)>(
    symbol: 'ts_query_is_pattern_guaranteed_at_step')
...
@ffi.Native<
    ffi.Pointer<ffi.Char> Function(ffi.Pointer<TSQuery>, ffi.Uint32,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_query_capture_name_for_id')
...
@ffi.Native<ffi.Int32 Function(ffi.Pointer<TSQuery>, ffi.Uint32, ffi.Uint32)>(
    symbol: 'ts_query_capture_quantifier_for_id')
external int ts_query_capture_quantifier_for_id(
  ffi.Pointer<TSQuery> self,
  int pattern_index,
  int capture_index,
);
...
@ffi.Native<
    ffi.Pointer<ffi.Char> Function(ffi.Pointer<TSQuery>, ffi.Uint32,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_query_string_value_for_id')
...
@ffi.Native<
    ffi.Void Function(ffi.Pointer<TSQuery>, ffi.Pointer<ffi.Char>,
        ffi.Uint32)>(symbol: 'ts_query_disable_capture')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSQuery>, ffi.Uint32)>(
    symbol: 'ts_query_disable_pattern')
...
@ffi.Native<
    ffi.Void Function(ffi.Pointer<TSQueryCursor>, ffi.Pointer<TSQuery>,
        TSNode)>(symbol: 'ts_query_cursor_exec')
...
@ffi.Native<
    ...
    symbol: 'ts_query_cursor_exec_with_options')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSQueryCursor>, ffi.Uint64)>(
    symbol: 'ts_query_cursor_set_timeout_micros')
...
@ffi.Native<ffi.Uint64 Function(ffi.Pointer<TSQueryCursor>)>(
    symbol: 'ts_query_cursor_timeout_micros')
...
@ffi.Native<
    ...
    symbol: 'ts_query_cursor_set_byte_range')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSQueryCursor>, TSPoint, TSPoint)>(
    symbol: 'ts_query_cursor_set_point_range')
...
@ffi.Native<
    ffi.Bool Function(ffi.Pointer<TSQueryCursor>,
        ffi.Pointer<TSQueryMatch>)>(symbol: 'ts_query_cursor_next_match')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSQueryCursor>, ffi.Uint32)>(
    symbol: 'ts_query_cursor_remove_match')
...
@ffi.Native<
    ffi.Bool Function(ffi.Pointer<TSQueryCursor>, ffi.Pointer<TSQueryMatch>,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_query_cursor_next_capture')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSQueryCursor>, ffi.Uint32)>(
    symbol: 'ts_query_cursor_set_max_start_depth')
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>(
    symbol: 'ts_language_symbol_count')
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>(
    symbol: 'ts_language_state_count')
...
@ffi.Native<
    TSSymbol Function(ffi.Pointer<TSLanguage>, ffi.Pointer<ffi.Char>,
        ffi.Uint32, ffi.Bool)>(symbol: 'ts_language_symbol_for_name')
...
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>(
    symbol: 'ts_language_field_count')
external int ts_language_field_count(
  ffi.Pointer<TSLanguage> self,
);

/// Get the field name string for the given numerical id.
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<TSLanguage>, TSFieldId)>(
    symbol: 'ts_language_field_name_for_id')
...
@ffi.Native<
    TSFieldId Function(ffi.Pointer<TSLanguage>, ffi.Pointer<ffi.Char>,
        ffi.Uint32)>(symbol: 'ts_language_field_id_for_name')
...
@ffi.Native<
    ffi.Pointer<TSSymbol> Function(ffi.Pointer<TSLanguage>,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_language_supertypes')
...
@ffi.Native<
    ffi.Pointer<TSSymbol> Function(ffi.Pointer<TSLanguage>, TSSymbol,
        ffi.Pointer<ffi.Uint32>)>(symbol: 'ts_language_subtypes')
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<TSLanguage>, TSSymbol)>(
    symbol: 'ts_language_symbol_name')
...
@ffi.Native<ffi.Int32 Function(ffi.Pointer<TSLanguage>, TSSymbol)>(
    symbol: 'ts_language_symbol_type')
external int ts_language_symbol_type(
  ffi.Pointer<TSLanguage> self,
  int symbol,
);
...
/// See also [`ts_parser_set_language`].
@ffi.Native<ffi.Uint32 Function(ffi.Pointer<TSLanguage>)>(
    symbol: 'ts_language_abi_version')
...
@ffi.Native<
    ffi.Pointer<TSLookaheadIterator> Function(ffi.Pointer<TSLanguage>,
        TSStateId)>(symbol: 'ts_lookahead_iterator_new')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSLookaheadIterator>)>(
    symbol: 'ts_lookahead_iterator_delete')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSLookaheadIterator>, TSStateId)>(
    symbol: 'ts_lookahead_iterator_reset_state')
...
/// otherwise.
@ffi.Native<
    ffi.Bool Function(ffi.Pointer<TSLookaheadIterator>, ffi.Pointer<TSLanguage>,
        TSStateId)>(symbol: 'ts_lookahead_iterator_reset')
...
@ffi.Native<ffi.Pointer<TSLanguage> Function(ffi.Pointer<TSLookaheadIterator>)>(
    symbol: 'ts_lookahead_iterator_language')
...
@ffi.Native<ffi.Bool Function(ffi.Pointer<TSLookaheadIterator>)>(
    symbol: 'ts_lookahead_iterator_next')
...
@ffi.Native<TSSymbol Function(ffi.Pointer<TSLookaheadIterator>)>(
    symbol: 'ts_lookahead_iterator_current_symbol')
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(ffi.Pointer<TSLookaheadIterator>)>(
    symbol: 'ts_lookahead_iterator_current_symbol_name')
...
@ffi.Native<
    ffi.Pointer<TSWasmStore> Function(ffi.Pointer<TSWasmEngine>,
        ffi.Pointer<TSWasmError>)>(symbol: 'ts_wasm_store_new')
...
@ffi.Native<
    ffi.Pointer<TSLanguage> Function(
        ...
        ffi.Pointer<ffi.Char>,
        ffi.Uint32,
        ffi.Pointer<TSWasmError>)>(symbol: 'ts_wasm_store_load_language')
...
@ffi.Native<ffi.Size Function(ffi.Pointer<TSWasmStore>)>(
    symbol: 'ts_wasm_store_language_count')
...
@ffi.Native<ffi.Void Function(ffi.Pointer<TSParser>, ffi.Pointer<TSWasmStore>)>(
    symbol: 'ts_parser_set_wasm_store')
...
@ffi.Native<ffi.Pointer<TSWasmStore> Function(ffi.Pointer<TSParser>)>(
    symbol: 'ts_parser_take_wasm_store')
...
abstract class TSInputEncoding {
  ...
  static const int TSInputEncodingUTF16LE = 1;
  static const int TSInputEncodingUTF16BE = 2;
  static const int TSInputEncodingCustom = 3;
}

abstract class TSSymbolType {
  static const int TSSymbolTypeRegular = 0;
  static const int TSSymbolTypeAnonymous = 1;
  static const int TSSymbolTypeSupertype = 2;
...
typedef DecodeFunction = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Uint32 Function(ffi.Pointer<ffi.Uint8> string, ffi.Uint32 length,
...
final class TSLogger extends ffi.Struct {
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<ffi.Void> payload, ffi.Int32 log_type,
              ffi.Pointer<ffi.Char> buffer)>> log;
}
...
abstract class TSWasmErrorKind {
  static const int TSWasmErrorKindNone = 0;
  static const int TSWasmErrorKindParse = 1;
  static const int TSWasmErrorKindCompile = 2;
  static const int TSWasmErrorKindInstantiate = 3;
  static const int TSWasmErrorKindAllocate = 4;
}
...
/// Compatibility wrapper class for TreeSitter API
/// 
/// This class provides backwards compatibility with the old dynamic loading API.
/// With @Native annotations, the class no longer needs to wrap DynamicLibrary lookup,
/// but it maintains the interface for compatibility.
class TreeSitter {
  /// Constructor that accepts a DynamicLibrary is maintained for API compatibility
  TreeSitter(ffi.DynamicLibrary _);
  
  /// Alternative constructor for symbol lookup compatibility
  TreeSitter.fromLookup(
      ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) _);

  /// Provides access to symbol addresses for use with NativeFinalizer
  static final addresses = _TreeSitterAddresses();
}

/// Helper class to provide symbol addresses for finalizers
/// Note: With @Native annotations, these placeholder addresses are kept for API compatibility
/// but may not be needed as @Native functions handle cleanup differently
class _TreeSitterAddresses {
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>> 
      get ts_parser_delete => 
          ffi.Pointer.fromAddress(0); // Placeholder
